          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ungoing Appointment</h4>
              ...
              <div class="col-lg-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Cancelled Appointment</h4>
                    <canvas id="light-chart"></canvas>
                    <div id="light-chart-legend" class="rounded-legend legend-vertical legend-bottom-left pt-4"></div>
                    ...
                    <table class="table table-bordered table-hover">
                      <thead>
                        <tr>
                          ...
                          <th> Numbers of assigned Staffs </th>
                          <th> Date</th>
                          <th> Status</th>
                          <th>Edit</th>
                          <th>Delete</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>completed</td>
                          <td>
                            <button type="button" class="btn btn-outline-info btn-icon-text"> Edit
                          </button>
                         </td>
