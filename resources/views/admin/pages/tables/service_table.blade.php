                        ...
                        <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>{{$services->id}}</td>
                              <td>{{$services->name}}</td>
                              <td> <a role="button" class="btn btn-outline-info btn-icon-text" href="{{route('service.edit',$services->id)}}"> Edit
                              </a></td>
                              <td><a role="button" class="btn btn-outline-danger btn-icon-text" href="{{route('service.destroy',$services->id)}}"> Delete
                              </a></td>
                            </tr>
