                                ...
                                <div class="col-12 grid-margin stretch-card">
                                  <div class="card">
                                    <div class="card-body">
                                      ...
                                      <form class="forms-sample" action="{{route('employee.update', $employee->id)}}" method="POST" enctype="multipart/form-data">

                                        @csrf

                                        <div class="form-group">
                                          <label for="exampleInputName1">Name</label>
                                          <input type="text" name="name" class="form-control" id="exampleInputName1" placeholder="Name" value="{{$employee->name}}">
                                        </div>
                                        @error('name')
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="email" name="email" class="form-control" id="exampleInputEmail3" placeholder="Email" value="{{$employee->email}}">
                                        </div>
                                        @error('email')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                        @enderror
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="phonenumber" class="form-control" id="exampleInputPassword4" placeholder="Phonenumber" value="{{$employee->phonenumber}}">
                                        </div>
                                        @error('phonenumber')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                        @enderror
                                        ...
                                        {{-- <div class="form-group">
                                          ...
                                          <input type="password" name="password" class="form-control" id="exampleInputPassword4" placeholder="Password"value="{{$employee->password}}">
                                        </div>
                                        @error('password')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                        @enderror
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="password" name="password_confirmation" class="form-control" id="exampleInputPassword4" placeholder="password confirmation">
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="age" class="form-control" id="exampleInputName1" placeholder="Age" value="{{$employee->age}}">
                                        </div>
                                        @error('age')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                        @enderror
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="city" class="form-control" id="exampleInputCity1" placeholder="Location" value="{{$employee->city}}">
                                        </div>
                                        @error('city')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                        @enderror
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea class="form-control" id="exampleTextarea1" name="service" rows="4">{{$employee->service}}</textarea>
                                        </div>
                                        @error('service')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                        @enderror
