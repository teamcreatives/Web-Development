                                    ...
                                    <div class="card-body">
                                      ...
                                      <form class="forms-sample" action="{{route('categories.update',$category->id)}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                          <label for="exampleInputEmail3">Service Id</label>
                                          <input type="text" name="service" class="form-control" id="exampleInputEmail3" placeholder="sevice_id" value="{{$category->service_id}}">
                                        </div>
                                        @error('service')
                                        ...
                                        <div class="form-group">
                                          <label for="exampleInputPassword4">Cost</label>
                                          <input type="text" name="cost" class="form-control" id="exampleInputPassword4" placeholder="#0.00" value="{{$category->cost}}">
                                        </div>
                                        @error('cost')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                        @enderror
