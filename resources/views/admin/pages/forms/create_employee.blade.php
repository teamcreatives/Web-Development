                                ...
                                <div class="col-12 grid-margin stretch-card">
                                  <div class="card">
                                    <div class="card-body">
                                      ...
                                      <p class="card-description"> Employee Register </p>
                                      ...
                                      <form class="forms-sample" action="{{route('employee.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="phonenumber" class="form-control" id="exampleInputPassword4" placeholder="Phonenumber">
                                        </div>
                                        @error('phonenumber')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                        @enderror
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea class="form-control" id="exampleTextarea1" name="service" rows="4"></textarea>
                                        </div>
                                        @error('service')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                        @enderror
