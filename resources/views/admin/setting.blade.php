          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-4 stretch-card grid-margin">
                    <div class="card bg-gradient-white card-img-holder text-white">
                      <div class="card-body text-info">
                        ...
                        <h3 class="text text-secondary text-center">Manage Employee Account</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                ...
                                <div class="m-3">
                                    ...
                                    <a href="#" class="btn btn-outline-info">Remove
                ...
                <div class="card bg-gradient-white card-img-holder text-white">
                  <div class="card-body text-info">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <h1><i class="mdi mdi-clipboard-text"></i></h1>
                        </div>
                    </div>

                    <h3 class="text text-secondary text-center">Service Schedule</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            <div class="m-3">
                                ...
                                <a href="#" class="btn btn-outline-info">View
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            <div class="m-3">
                                ...
                                <a href="#" class="btn btn-outline-info">change
                    ...
                    <div class="card bg-gradient-white card-img-holder text-white">
                      <div class="card-body text-info">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <h1><i class="mdi mdi-disqus-outline"></i></h1>
                            </div>
                        </div>

                        <h3 class="text text-secondary text-center">Equipment and Supply Information</h3>
                ...
                <div class="col-md-5 stretch-card grid-margin">
                    <div class="card bg-gradient-white card-img-holder text-white">
                      <div class="card-body text-info">
                                ...
                                <h3 class="text text-secondary text-center">Users Data</h3>
